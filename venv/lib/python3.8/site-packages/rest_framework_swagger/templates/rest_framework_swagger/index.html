...
<body>
      ...
      <div class="wrapper">
        <div class="topbar-wrapper">
          ...
          {% if USE_SESSION_AUTH %}
            ...
            <a class="download-url-button button" href="{{ LOGOUT_URL }}?next={{ request.path }}"></a>
            {% else %}
            <a class="download-url-button button" href="{{ LOGIN_URL }}?next={{ request.path }}"></a>
            {% endif %}
          {% endif %}
          </div>
        </div>
  ...
  <footer class="swagger-ui">
    <div class="wrapper">
      <a href="https://github.com/marcgibbons/django-rest-swagger" target="_new">Django REST Swagger</a>
    </div>
  </footer>
